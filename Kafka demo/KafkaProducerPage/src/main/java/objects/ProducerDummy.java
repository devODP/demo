...
public class ProducerDummy {
	...
	public void pushMessage(String symbol) throws IOException {
		...
		props.put("bootstrap.servers", "kafka_server_host:9094");
		...
		consoMge = consoMge + "Tesla stock symbol: " + sbl + "\nStock price: " + price + "\nTime of the stock price " + timeClosedPrice + "\n";

		
		//send messages to topic
		ProducerRecord<Integer, String> producerRecord = new ProducerRecord<Integer, String>("KafkaTestTopic", 0, consoMge);
